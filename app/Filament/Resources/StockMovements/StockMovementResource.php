...
class StockMovementResource extends Resource
{
    ...
    protected static string|UnitEnum|null $navigationGroup = 'Stoku';

    protected static ?int $navigationSort = 2;

    protected static ?string $navigationLabel = 'Hyrje / Dalje';

    protected static ?string $modelLabel = 'lëvizje stoku';

    protected static ?string $pluralModelLabel = 'Hyrje / Dalje';
